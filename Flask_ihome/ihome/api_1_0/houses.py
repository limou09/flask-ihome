...
def get_house_detail(house_id):
    ...
    if ret and ret != b'null':
        ...
        # return jsonify(errno='0', errmsg="OK", data={"user_id": user_id, "house":str(ret,encoding='utf8')})
        return '{"errno":"0", "errmsg":"OK", "data":{"user_id":%s, "house":%s}}' % (user_id, str(ret,encoding='utf8')), \
